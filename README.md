...
The program will give you two options, one is compress a file and other is decompress a file. To compress a file, the program will compress the file and write the compressed data in output file. To decompress a file, the program will decompress the file and write the decompressed data in output file. The huffman program is implemented using a priority queue to create the huffman tree.